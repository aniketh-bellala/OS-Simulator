...
function displayPartSize() {
    ...
    for(i = 1; i <= num_parts; i++)
    {
        htmlText += 
        `
        <div class="form-group" style="padding:2vh 0vh; background-color: #DFDFDE;">
    ...
    htmlText += 
    `
    <button type="submit" class="btn btn-success" id="parts-size-btn">Submit</button>
    `;
...
function startColumn2() {
    var htmlText = 
    `
    <button type="submit" class="btn btn-success" id="add-pro-btn">Add process</button>
    <button type="submit" class="btn btn-success" id="rem-pro-btn">Remove process</button>
    `;
    $("#add-rem-pro-btns").html(htmlText);
    var htmlText = 
    `<div class="hi" style="background-color: #DFDFDE"><h3 style="margin-left:45vh !important;">Main Memory</h3>
    <canvas id="myCanvas" width="170" height="520" style="border:2px solid black; margin-left:45vh !important;">
...
function addProcess(pro_size, pro_id, fromQ) {
    ...
    if(found == 0 && fromQ == 0) {
        alert('The process size is bigger than all the partitionNew process size is large. Process added to Input Queue');
        `<p>Process size is too large</p>`
...
function remProcessId() {
    ...
    <button type="submit" class="btn btn-success" id="rem-btn">Remove</button>
    `;
    $("#add-rem-pro").html(htmlText);
    $(document).ready(function() {
