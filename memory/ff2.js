...
function startColumn2() {
    ...
    var htmlText = 
    `
    <canvas id="myCanvas" width="170" height="520" style="border:2px solid black;">
...
function addProcessSize() {
    ...
    <div class="form-group">
        <label style="margin-top:5vh">Size of process to be added: </label>
...
function remProcessId() {
    ...
    `
    <div class="form-group">
        <label style="margin-top:5vh">Id of process to be removed: </label>
...
function drawInputQTable() {
    var htmlText = 
    `
    <button type="submit" class="btn btn-success md-3" id="compact-btn">Compact</button> 
    <table>
    <tr>
